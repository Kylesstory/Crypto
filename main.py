...
.. module:: CryptoAlgorithms
   :synopsis: The implementation of cryptographic algorithms.
.. moduleauthor:: Kyle
"""
...
commits = [Commit.HashCommit(security << 1), Commit.RSA(security),
           Commit.ElGamal(security), Commit.Pedersen(security)]
...
nizks = [NIZK.Schnorr(security), NIZK.GuillouQuisquater(security),
